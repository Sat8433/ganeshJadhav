...
export const metadata: Metadata = {
  title: "About Ganesh Jadhav | Real Estate Data Intelligence",
  description:
    "Learn about Ganesh Jadhav's mission to re-engineer property due diligence and bring transparency to the Indian real estate market through data-driven intelligence.",
}

export default function AboutPage() {
  return (
    <div className="bg-gray-50 text-gray-800 font-sans min-h-screen pt-20">
      <main>
        {/* Hero Section */}
        ...
        <section className="py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mt-4 text-gray-600">
                Ganesh Jadhav was born from this challenge. We are dedicated to creating the largest centralized
        ...
        <section className="bg-indigo-700">
          <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <a
              href="mailto:contact@ganeshjadhav.com"
      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">&copy; 2024 Ganesh Jadhav. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
