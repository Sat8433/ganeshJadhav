...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("[v0] Login successful, session established:", data.session?.access_token ? "Yes" : "No")

      // Wait for cookies to be set, then do a hard redirect
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="border-gray-200 dark:border-gray-800">
            <CardHeader>
              ...
              <CardDescription>Sign in to access your property insights</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                <div className="text-center">
                  <Link
                    href="/auth/admin-access"
                    className="text-xs text-gray-500 hover:text-gray-700 dark:text-gray-500 dark:hover:text-gray-300 flex items-center justify-center gap-1"
                  >
